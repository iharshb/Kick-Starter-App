import 'dart:convert';
import 'package:kickstarter/utils/utils_encryption.dart';
import 'package:shared_preferences/shared_preferences.dart';
import 'package:synchronized/synchronized.dart';

/// SharedPreferences Util.
class PreferenceManager {
  static PreferenceManager? _prefManager;
    ...
    if (_prefManager == null) {
      await _lock.synchronized(() async {
        if (_prefManager == null) {
          ...
          var singleton = PreferenceManager._();
          await singleton._init();
          _prefManager = singleton;
        }
      });
    }
    return _prefManager;
  ...
  static Future<bool>? putString(String key, String value) {
    ...
    return _prefs!.setString(key, EncryptUtils.encodeBase64(value));
  }
