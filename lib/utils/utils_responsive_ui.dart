...
class Screen {
  ...
  double getWidthPx(int pixels) {
    return ScreenUtil().setWidth(pixels);
  }

  double getHeightPx(int pixels) {
    return ScreenUtil().setHeight(pixels);
  }

  double setSp(int pixels) {
    return ScreenUtil().setSp(pixels);
  }

  bool isTablet() {
    return screenSize.width > 600 ? true : false;
  }
}
